%% 
%% Elsevier LaTeX Template for Big Data Analytics IA
%% Third-Year AI & DS - K J Somaiya College of Engineering
%% Single File Version - All Content Included
%% 
...
%% Authors
\author[somaiya]{Student Name 1}
\ead{student1@somaiya.edu}

\author[somaiya]{Student Name 2}
\ead{student2@somaiya.edu}

\author[somaiya]{Student Name 3}
\ead{student3@somaiya.edu}

\author[somaiya]{Student Name 4}
\ead{student4@somaiya.edu}

%% Author affiliation
\affiliation[somaiya]{organization={Department of Information Technology, K J Somaiya School of Engineering (formerly K J Somaiya College of Engineering), Somaiya Vidyavihar University},
           addressline={Vidyavihar}, 
           city={Mumbai},
           postcode={400077}, 
           state={Maharashtra},
           country={India}}
...
%% Keywords (5-10 terms)
\begin{keyword}
Big Data Analytics; Machine Learning; Microfinance; Credit Scoring; Loan Default Prediction; Apache Spark; XGBoost; Blockchain; Financial Inclusion; Distributed Computing
\end{keyword}
...
%% ============================================================
%% SECTION 2: FOUNDATIONAL CONCEPTS (Pages 3-6)
%% ============================================================
...
%% ============================================================
%% SECTION 3: LITERATURE REVIEW (Pages 7-10)
%% ============================================================
...
%% ============================================================
%% SECTION 4: PROPOSED METHODOLOGY (Pages 11-15)
%% ============================================================
...
%% ============================================================
%% SECTION 5: CASE STUDY IMPLEMENTATION (Pages 16-21)
%% ============================================================
...
Local ML & scikit-learn 1.3+, XGBoost 2.0+ \\
Distributed & PySpark 3.5.4, Spark MLlib \\
...
\midrule
Logistic Regression & 0.694 & 0.228 & 0.686 & 0.343 & \textbf{0.758} \\
Random Forest & \textbf{0.867} & \textbf{0.392} & 0.257 & 0.311 & 0.745 \\
XGBoost & 0.699 & 0.227 & \textbf{0.663} & 0.338 & 0.746 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Spark MLlib Model Performance}
\label{tab:spark_results}
\begin{tabular}{@{}lccccc@{}}
\toprule
Model & Accuracy & Precision & Recall & F1-Score & ROC-AUC \\
\midrule
Spark LR & 0.890 & 0.861 & 0.890 & 0.847 & 0.756 \\
Spark RF & 0.890 & 0.866 & 0.890 & 0.843 & 0.739 \\
Spark GBT & 0.888 & 0.853 & 0.888 & 0.849 & 0.750 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Cross-Validation ROC-AUC Scores (Local Models)}
...
\begin{itemize}
    \item Random Forest achieves the highest accuracy (86.7\%) and precision (39.2\%) among local models
    ...
    \item Spark MLlib models achieve higher accuracy (~89\%) with competitive ROC-AUC scores
    \item Cross-validation ROC-AUC scores are substantially higher for ensemble models ($>$0.96), suggesting strong generalization
\end{itemize}
...
%% ============================================================
%% SECTION 6: CRITICAL DISCUSSION & LIMITATIONS (Pages 22-23)
%% ============================================================
...
%% ============================================================
%% SECTION 7: CONCLUSION & FUTURE SCOPE (Pages 24-25)
%% ============================================================
...
%% ============================================================
%% REFERENCES (35 Citations Inline)
%% ============================================================
...
Dastile, X., Celik, T., Potsane, M.: Statistical and machine learning models in credit scoring: A systematic literature survey. Applied Soft Computing 91, 106263 (2020)
...
Li, S., Li, P.: Quantum-inspired evolutionary algorithms with a new termination criterion. Applied Soft Computing 92, 106073 (2020)
